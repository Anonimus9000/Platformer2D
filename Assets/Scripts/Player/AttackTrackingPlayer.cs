...
public class AttackTrackingPlayer : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (_spriteRendererPlayer.flipX == false) _circleCollider.offset = new Vector2(0, 0);
    }
    ...
    public void Attack()
    {
        ...
        if (_spriteRendererPlayer.flipX == true)
        {
            ...
            var trackPosition = new Vector3(posX - _circleCollider.radius * 2, gameObject.transform.position.y,
